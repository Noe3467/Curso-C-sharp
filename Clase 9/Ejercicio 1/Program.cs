...
Console.WriteLine("ingresá la cantidad de números aleatorios"); //paso1
int cantNumAleat = int.Parse(Console.ReadLine()); 
int[] aleatorios = new int[cantNumAleat]; //paso2

for (int i = 0;  i< aleatorios.Length; i++)
{
    aleatorios[i] = aleatorio.Next(0,100); //paso3
}
